/*
 ...
 Source Schema         : smart_park_parking_management_system
...
CREATE TABLE `access_log`  (
  ...
  CONSTRAINT `fk_access_gate` FOREIGN KEY (`gate_id`) REFERENCES `gate_device` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
CREATE TABLE `parking_space`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_area_space`(`park_area_id` ASC, `space_number` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
