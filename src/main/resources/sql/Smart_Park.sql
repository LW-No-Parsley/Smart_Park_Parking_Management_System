...
CREATE TABLE `access_log` (
  ...
  `vehicle_id` bigint DEFAULT NULL COMMENT '关联车辆ID（可为空）',
  `access_type` tinyint NOT NULL COMMENT '进出类型：1-入场，2-出场',
  `image_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '抓拍图片地址',
  `recognition_result` tinyint DEFAULT '1' COMMENT '识别结果：0-失败，1-成功，2-黑名单',
  `access_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '通行时间',
  `handled_by` bigint DEFAULT NULL COMMENT '处理人员ID（后台 sys_user.id，用于手动干预）',
  `remark` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注（手动放行原因等）',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_plate` (`plate_number`) USING BTREE,
  KEY `idx_access_time` (`access_time`) USING BTREE,
  KEY `idx_gate` (`gate_id`) USING BTREE,
  KEY `idx_vehicle` (`vehicle_id`) USING BTREE,
  KEY `idx_park_area` (`park_area_id`) USING BTREE,
  KEY `idx_handled_by` (`handled_by`) USING BTREE,
...
CREATE TABLE `blacklist` (
  ...
  `updated_by` bigint DEFAULT NULL COMMENT '更新人（sys_user.id）',
  `start_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '生效时间',
  `end_time` datetime DEFAULT NULL COMMENT '失效时间',
  `status` tinyint DEFAULT '1' COMMENT '状态：0-禁用，1-生效',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  `park_area_id` bigint DEFAULT NULL COMMENT '所属园区ID',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_status_time` (`status`,`end_time`) USING BTREE,
  KEY `idx_plate_status_end_time` (`plate_number`,`status`,`end_time`) USING BTREE,
  KEY `idx_plate_start_time` (`plate_number`,`start_time`) USING BTREE,
  KEY `fk_blacklist_created_by` (`created_by`) USING BTREE,
  KEY `fk_blacklist_updated_by` (`updated_by`) USING BTREE,
  KEY `idx_blacklist_area` (`park_area_id`),
  CONSTRAINT `fk_blacklist_area` FOREIGN KEY (`park_area_id`) REFERENCES `park_area` (`id`) ON DELETE CASCADE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='黑名单表';
...
CREATE TABLE `exception_report` (
  ...
  `image_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片地址',
  `status` tinyint DEFAULT '0' COMMENT '处理状态：0-未处理，1-已受理，2-已处理，3-已关闭',
  `handled_by` bigint DEFAULT NULL COMMENT '处理人员ID（后台 sys_user.id）',
  ...
  KEY `idx_space` (`space_id`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='异常上报表';
...
CREATE TABLE `gate_device` (
  ...
  `ip_address` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '设备IP地址',
  `device_type` tinyint DEFAULT '1' COMMENT '设备类型：1-入口道闸，2-出口道闸',
...
CREATE TABLE `operation_log` (
  ...
  `user_id` bigint NOT NULL COMMENT '操作用户ID（park_user.id）',
  ...
  `detail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '操作详情（JSON格式）',
  ...
  CONSTRAINT `fk_log_user` FOREIGN KEY (`user_id`) REFERENCES `park_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志表（业务操作）';
...
CREATE TABLE `park_area` (
  ...
  `address` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '园区地址',
  `total_spaces` int DEFAULT '0' COMMENT '总车位数量',
  `primary_admin_user_id` bigint DEFAULT NULL COMMENT '主园区管理员ID（sys_user.id）',
  `latitude` decimal(10,6) DEFAULT NULL COMMENT '园区纬度坐标',
  `longitude` decimal(10,6) DEFAULT NULL COMMENT '园区经度坐标',
  `business_hours_start` time DEFAULT '08:00:00' COMMENT '营业开始时间',
  `business_hours_end` time DEFAULT '22:00:00' COMMENT '营业结束时间',
  `status` tinyint DEFAULT '1' COMMENT '园区状态：0-关闭，1-开放',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `park_user` (
  ...
  `username` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户名（微信昵称）',
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '手机号',
  `openid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信openid（用于微信登录）',
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='园区用户表（车主/访客等业务用户）';
...
CREATE TABLE `parking_space` (
  ...
  `park_area_id` bigint NOT NULL COMMENT '园区ID',
  `zone_id` bigint DEFAULT NULL COMMENT '分区ID（parking_zone.id）',
  ...
  `status` tinyint DEFAULT '1' COMMENT '车位状态：0-禁用，1-正常，4-故障',
  `latitude` decimal(10,6) DEFAULT NULL COMMENT '车位纬度坐标（用于导航）',
  `longitude` decimal(10,6) DEFAULT NULL COMMENT '车位经度坐标（用于导航）',
  `bind_user_id` bigint DEFAULT NULL COMMENT '绑定用户ID（固定车位，关联 park_user.id）',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_status` (`status`) USING BTREE,
  KEY `idx_bind_user` (`bind_user_id`) USING BTREE,
  KEY `idx_space_type` (`space_type`) USING BTREE,
  KEY `idx_zone_id` (`zone_id`) USING BTREE,
  KEY `idx_area_zone_status` (`park_area_id`,`zone_id`,`status`) USING BTREE,
...
CREATE TABLE `parking_zone` (
  ...
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分区描述',
  ...
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_area_zone` (`park_area_id`,`zone_name`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='车位分区表（单层分区）';
...
CREATE TABLE `payment_record` (
  ...
  `transaction_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '第三方支付交易ID',
  ...
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_reservation` (`reservation_id`) USING BTREE,
  KEY `idx_user` (`user_id`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='支付记录表';
...
CREATE TABLE `refund_record` (
  ...
  `refund_status` tinyint DEFAULT '0' COMMENT '退款状态：0-处理中，1-成功，2-失败',
  `refund_time` datetime DEFAULT NULL COMMENT '退款时间',
  `transaction_refund_id` varchar(100) DEFAULT NULL COMMENT '第三方退款交易号',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_payment` (`payment_id`),
  KEY `idx_reservation` (`reservation_id`),
  CONSTRAINT `fk_refund_payment` FOREIGN KEY (`payment_id`) REFERENCES `payment_record` (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_refund_reservation` FOREIGN KEY (`reservation_id`) REFERENCES `reservation` (`id`) ON DELETE RESTRICT
...
CREATE TABLE `reservation` (
  ...
  `approved_by` bigint DEFAULT NULL COMMENT '审批人（sys_user.id）',
  ...
  `created_by` bigint DEFAULT NULL COMMENT '创建人（sys_user.id；小程序创建则为空）',
  `source` tinyint NOT NULL DEFAULT '1' COMMENT '创建来源：1-小程序，2-后台管理员，3-保安',
  `start_time` datetime(6) NOT NULL,
  `end_time` datetime(6) NOT NULL,
  `status` tinyint DEFAULT '1' COMMENT '预约状态：0-已取消，1-已预约，2-已使用，3-已过期',
  `arrive_time` datetime DEFAULT NULL COMMENT '实际到达时间',
  `leave_time` datetime DEFAULT NULL COMMENT '实际离开时间',
  `total_fee` decimal(10,2) DEFAULT '0.00' COMMENT '最终结算停车费用（整单）',
  `paid_amount` decimal(10,2) DEFAULT '0.00' COMMENT '已支付金额（缓存字段，便于列表查询）',
  `settlement_time` datetime DEFAULT NULL COMMENT '结算时间（通常为离场或管理员结算时）',
  `pay_status` tinyint DEFAULT '0' COMMENT '整单支付状态：0-未支付，1-已支付，2-部分支付，3-已退款',
  ...
  KEY `idx_space_time` (`space_id`,`start_time`,`end_time`) USING BTREE,
  KEY `fk_reservation_approved_by` (`approved_by`) USING BTREE,
  KEY `fk_reservation_created_by` (`created_by`) USING BTREE,
...
CREATE TABLE `sys_login_log` (
  ...
  `browser` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '浏览器类型',
...
CREATE TABLE `sys_permission` (
  ...
  `path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '权限路径',
...
CREATE TABLE `sys_token_jti_blacklist` (
  ...
  `user_id` bigint DEFAULT NULL COMMENT '关联后台用户 sys_user.id',
  ...
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '拉黑原因',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_jti` (`jti`) USING BTREE,
  KEY `idx_expiration_time` (`expiration_time`) USING BTREE,
  KEY `idx_user_id` (`user_id`) USING BTREE,
...
CREATE TABLE `sys_user_park_area` (
  ...
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_park` (`user_id`,`park_area_id`) USING BTREE,
  KEY `idx_park_area_id` (`park_area_id`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='后台用户-园区授权范围表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='系统配置表';
...
CREATE TABLE `vehicle` (
  ...
  `plate_number` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '车牌号',
  `is_default` tinyint DEFAULT '0' COMMENT '是否默认车牌：0-否，1-是',
  `vehicle_type` tinyint DEFAULT '1' COMMENT '车辆类型：1-小车，2-大车，3-新能源车',
  `brand` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '车辆品牌',
  `color` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '车辆颜色',
  `status` tinyint DEFAULT '1' COMMENT '车辆状态：0-禁用，1-正常',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` tinyint DEFAULT '0' COMMENT '逻辑删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='车辆表';
